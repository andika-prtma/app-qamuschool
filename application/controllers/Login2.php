...
class Login extends CI_Controller {
	...
	private function procLogin(){
		...
		if ($user) {
			if (password_verify($password, $user->password)) {
				...
				$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Welcome</div>');
				redirect('home');
			} else {
	...
	public function inputPassword(){
		...
		if ($this->form_validation->run() == false) {
			$this->load->view("home/s-header");
    		$this->load->view("home/c-header");
    		$this->load->view("login/input-password");
    		$this->load->view("home/c-footer");
    		$this->load->view("home/s-footer");
		} else {
