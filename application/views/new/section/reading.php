...
<html lang="en">
  ...
  <body>
  	<div class="container">
  		<?= form_open('calculate/reading_proses', 'id="theForm"') ?>
  ...
  box-shadow: 10px 10px 5px #aaaaaa;">
		...
		<div class="" style="margin-top: 150px">		
			...
			<img width="95%" src="<?= base_url('assets/img/soal/3/section3/passage1.PNG') ?>"><br>

			<?php foreach ($soal->result() as $sl): ?> 

				<?php if ($sl->nomor == '11'): ?>
					<img width="95%" src="<?= base_url("assets/img/soal/$sl->id_paket/section3/passage2.PNG") ?>"><br>
				<?php endif ?>
				<?php if ($sl->nomor == '22'): ?>
					<img width="95%" src="<?= base_url("assets/img/soal/$sl->id_paket/section3/passage3.PNG") ?>"><br>
				<?php endif ?>
				<?php if ($sl->nomor == '32'): ?>
					<img width="95%" src="<?= base_url("assets/img/soal/$sl->id_paket/section3/passage4.PNG") ?>"><br>
				<?php endif ?>
				<?php if ($sl->nomor == '41'): ?>
					<img width="95%" src="<?= base_url("assets/img/soal/$sl->id_paket/section3/passage5.PNG") ?>"><br>
				<?php endif ?>
...
<script type="text/javascript">
    function simpan_jawaban(){
         $.ajax({
          url:"<?= base_url() ?>calculate/reading_proses_ajax",
          method:"POST",
