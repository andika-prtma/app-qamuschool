...
<html lang="en">
  ...
  box-shadow: 10px 10px 5px #aaaaaa;">
		...
		<div class="" style="margin-top: 150px">		
			...
			<h5>PART A</h5>
			<h5>Direction : </h5>
			<p>In part A, you will here short conversations between two people. After each conversation, you will hear a question bout the conversation. The conversations and questions will not be repeated. After you hear a question, read the four possible answers in your book and choose the best answer. Then, on your answer sheet, find the number of the question and fill in the space that correspondsto the letter of the answer you have chosen.</p><br>
			<p>Example:</p>
...
<script type="text/javascript">
    function simpan_jawaban(){
         $.ajax({
          url:"<?= base_url() ?>hitung/listening_proses",
          method:"POST",
